...
open class BottomSheetContainerViewController <Content: UIViewController,
    ...
    @objc func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        case .began, .changed:
            if self.state == .full {
                /* Assert that the user scrolls down ward.
                The bottom sheet is already at its full height; no upward scrolling is allowed*/
                ...
                /* Calculate the new constant by using the BottomSheetConfiguration’s initialOffset
                 and the translation magnitude */
